...
namespace BovineLabs.Core.Iterators
{
        ...
        where T : unmanaged, IBufferElementData
    {
        ...
        public bool TryGetBuffer(Entity entity, out UnsafeDynamicBuffer<T> bufferData)
        {
            ...
            if (header != null)
            {
                bufferData = new UnsafeDynamicBuffer<T>(header, internalCapacity);
                return true;
            }
            else
            {
        ...
        public void IsComponentEnabled(Entity entity) => this.IsBufferEnabled(entity);
        ...
        public void SetComponentEnabled(Entity entity, bool value) => this.SetBufferEnabled(entity, value);
