...
namespace BovineLabs.Core.Collections
{
        ...
        where TValue : unmanaged
    {
        ...
        public bool TryGetFirstValue(TKey key, out Ptr<TValue> item, out BlobMultiHashMapIterator<TKey> it) => this.Data.TryGetFirstValue(key, out item, out it);
        ...
        public bool TryGetNextValue(out Ptr<TValue> item, ref BlobMultiHashMapIterator<TKey> it) => this.Data.TryGetNextValue(out item, ref it);
